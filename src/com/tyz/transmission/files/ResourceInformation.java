...
public class ResourceInformation {
    ...
    public List<FileInformation> findLostFileInResource(String resourceName) throws Exception {
        List<FileInformation> incompleteFiles = new ArrayList<>(this.fileInformationMap.values());
     ...
     */
    public void scanResourceFiles(String resourceName) throws Exception {
        File resourceFile = creatRootFile(resourceName);
        this.fileId = 0;
    ...
    /**
     * 复制一份 {@code fileInformationMap} 并返回
     *
     * @return 复制的 fileInformationMap
     */
    public Map<Integer, FileInformation> getFileInformationMap() {
        return new HashMap<>(fileInformationMap);
    }
     ...
     * TODO for test
     */
    public ResourceInformation copyOf() {
        ResourceInformation res = new ResourceInformation(this.resourceId, this.absolutePath);
        res.fileInformationMap = new HashMap<>(this.fileInformationMap);
        res.directoryList = new ArrayList<>(this.directoryList);
        return res;
    }
}
